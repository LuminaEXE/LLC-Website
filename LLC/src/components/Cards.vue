	...
	<div class="page-content">
		<div class="card">
			<div class="content">
				...
				<div class="copy">Heres some of my hobbies</div>
				<RouterLink to='/hobbies' class="btn">Read More</RouterLink>
			</div>
		</div>
		<div class="card">
			<div class="content">
...
<script lang="ts"> export default { name: 'Cards' } </script>
...
.card {
	...
	box-shadow: 1px 1px 3px rgb(25, 25, 25),
		1px 4px 12px rgba(0, 0, 0, 0.402),
		0 4px 4px rgba(0, 0, 0, 0.1),
		0 8px 8px rgba(0, 0, 0, 0.537),
		0 16px 16px rgba(0, 0, 0, 0.266);
